...
/**
 * Created by androidusr1 on 19/9/16.
 */
public class EditshipmentDate extends DialogFragment implements DatePickerDialog.OnDateSetListener {

    TextView source;
    int year, month, day;
    public static int s_date, s_month, s_year;

    public EditshipmentDate() {
        //Required no Constructor
    }

    @SuppressLint("ValidFragment")
    public EditshipmentDate(TextView textView) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        year = NewJobScreen.s_year;
        month = NewJobScreen.s_month;
        day = NewJobScreen.s_date;
        ...
        try {
            ...
            dpd.getDatePicker().updateDate(NewJobScreen.s_year, NewJobScreen.s_month-1, NewJobScreen.s_date);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return dpd;
