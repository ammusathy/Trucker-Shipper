...
/**
 * Created by nijamudhin on 5/28/2016.
 */
public class PayPal extends Activity implements View.OnClickListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PAYPAL_REQUEST_CODE) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                Log.i("paymentExample", "An invalid PaymentInfo or PayPalConfiguration was submitted. Please see the docs.");
            }
        }
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(PayPal.this, SlidingDrawer.class);
